...
<html lang="en">
    ...
    <?php
      foreach($nieuwsberichten as $nieuwsberichten ){
            echo $nieuwsberichten['Amsterdam'];
            echo $nieuwsberichten['Sport'];
            $nieuwsberichten['Economie'];
            echo $nieuwsberichten['Onderwijs'];
       ?>     
         <h1></h1>
         <div class="content">
